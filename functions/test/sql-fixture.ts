...
export const ids = {
  ...
  mapping: "00000000-0000-4000-8000-000000000013",
};
export async function seed(db: PGlite) {
  ...
  await db.query("INSERT INTO role_page_permissions(role_id,page_id,tenant_id,can_access,can_update,can_manage,can_create) VALUES ($1,$2,$3,true,true,true,true)",[ids.role,ids.page,ids.tenant]);
  ...
  await db.query("INSERT INTO products(id,tenant_id,name,sale_price_cents) VALUES ($1,$2,'Produto',1500)",[ids.product,ids.tenant]);
