...
type Item = { id: string; externalItemId?: string | null; name: string; quantity: number; unitPriceCents: string; totalCents: string; observation?: string | null };
