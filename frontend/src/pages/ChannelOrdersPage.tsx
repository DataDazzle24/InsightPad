...
type Item = { id: string; productId?: string | null; productName?: string | null; productUsable?: boolean; mappingStatus: string; externalItemId?: string | null; externalProductId?: string | null; ean?: string | null; name: string; quantity: number; unitPriceCents: string; totalCents: string; observation?: string | null; allowNegativeStock?: boolean; physicalStock?: number; reservedStock?: number; availableStock?: number };
