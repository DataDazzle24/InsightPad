...
exports.useConnectSalesChannelMerchant = function useConnectSalesChannelMerchant(dcOrOptions, options) {
  const { dc: dcInstance, vars: inputOpts } = validateArgs(connectorConfig, dcOrOptions, options);
  function refFactory(vars) {
    return connectSalesChannelMerchantRef(dcInstance, vars);
  }
  return useDataConnectMutation(refFactory, inputOpts, CallerSdkTypeEnum.GeneratedReact);
}
...
exports.useSystemRefreshSalesChannelOrderAfterPicking = function useSystemRefreshSalesChannelOrderAfterPicking(dcOrOptions, options) {
  const { dc: dcInstance, vars: inputOpts } = validateArgs(connectorConfig, dcOrOptions, options);
  function refFactory(vars) {
