...
const bootstrapSalesChannelsNavigationV2Ref = (dc) => {
  const { dc: dcInstance} = validateArgs(connectorConfig, dc, undefined);
  dcInstance._useGeneratedSdk();
  return mutationRef(dcInstance, 'BootstrapSalesChannelsNavigationV2');
}
bootstrapSalesChannelsNavigationV2Ref.operationName = 'BootstrapSalesChannelsNavigationV2';
exports.bootstrapSalesChannelsNavigationV2Ref = bootstrapSalesChannelsNavigationV2Ref;

exports.bootstrapSalesChannelsNavigationV2 = function bootstrapSalesChannelsNavigationV2(dc) {
  const { dc: dcInstance, vars: inputVars } = validateArgs(connectorConfig, dc, undefined);
  return executeMutation(bootstrapSalesChannelsNavigationV2Ref(dcInstance, inputVars));
}
;
...
const createSalesChannelProductMappingRef = (dcOrVars, vars) => {
  const { dc: dcInstance, vars: inputVars} = validateArgs(connectorConfig, dcOrVars, vars, true);
  dcInstance._useGeneratedSdk();
  return mutationRef(dcInstance, 'CreateSalesChannelProductMapping', inputVars);
}
createSalesChannelProductMappingRef.operationName = 'CreateSalesChannelProductMapping';
exports.createSalesChannelProductMappingRef = createSalesChannelProductMappingRef;

exports.createSalesChannelProductMapping = function createSalesChannelProductMapping(dcOrVars, vars) {
  const { dc: dcInstance, vars: inputVars } = validateArgs(connectorConfig, dcOrVars, vars, true);
  return executeMutation(createSalesChannelProductMappingRef(dcInstance, inputVars));
}
;

const updateSalesChannelProductMappingRef = (dcOrVars, vars) => {
  const { dc: dcInstance, vars: inputVars} = validateArgs(connectorConfig, dcOrVars, vars, true);
  dcInstance._useGeneratedSdk();
  return mutationRef(dcInstance, 'UpdateSalesChannelProductMapping', inputVars);
}
updateSalesChannelProductMappingRef.operationName = 'UpdateSalesChannelProductMapping';
exports.updateSalesChannelProductMappingRef = updateSalesChannelProductMappingRef;

exports.updateSalesChannelProductMapping = function updateSalesChannelProductMapping(dcOrVars, vars) {
  const { dc: dcInstance, vars: inputVars } = validateArgs(connectorConfig, dcOrVars, vars, true);
  return executeMutation(updateSalesChannelProductMappingRef(dcInstance, inputVars));
}
;

const archiveSalesChannelProductMappingRef = (dcOrVars, vars) => {
  const { dc: dcInstance, vars: inputVars} = validateArgs(connectorConfig, dcOrVars, vars, true);
  dcInstance._useGeneratedSdk();
  return mutationRef(dcInstance, 'ArchiveSalesChannelProductMapping', inputVars);
}
archiveSalesChannelProductMappingRef.operationName = 'ArchiveSalesChannelProductMapping';
exports.archiveSalesChannelProductMappingRef = archiveSalesChannelProductMappingRef;

exports.archiveSalesChannelProductMapping = function archiveSalesChannelProductMapping(dcOrVars, vars) {
  const { dc: dcInstance, vars: inputVars } = validateArgs(connectorConfig, dcOrVars, vars, true);
  return executeMutation(archiveSalesChannelProductMappingRef(dcInstance, inputVars));
}
;

const queueSalesChannelOrderActionRef = (dcOrVars, vars) => {
  const { dc: dcInstance, vars: inputVars} = validateArgs(connectorConfig, dcOrVars, vars, true);
  dcInstance._useGeneratedSdk();
...
exports.queueSalesChannelOrderActionRef = queueSalesChannelOrderActionRef;

exports.queueSalesChannelOrderAction = function queueSalesChannelOrderAction(dcOrVars, vars) {
  const { dc: dcInstance, vars: inputVars } = validateArgs(connectorConfig, dcOrVars, vars, true);
  return executeMutation(queueSalesChannelOrderActionRef(dcInstance, inputVars));
}
;

const retrySalesChannelCommandRef = (dcOrVars, vars) => {
  const { dc: dcInstance, vars: inputVars} = validateArgs(connectorConfig, dcOrVars, vars, true);
  dcInstance._useGeneratedSdk();
...
exports.retrySalesChannelCommandRef = retrySalesChannelCommandRef;

exports.retrySalesChannelCommand = function retrySalesChannelCommand(dcOrVars, vars) {
  const { dc: dcInstance, vars: inputVars } = validateArgs(connectorConfig, dcOrVars, vars, true);
...
const requestSalesChannelOrderReconciliationRef = (dcOrVars, vars) => {
  const { dc: dcInstance, vars: inputVars} = validateArgs(connectorConfig, dcOrVars, vars, true);
  dcInstance._useGeneratedSdk();
  return mutationRef(dcInstance, 'RequestSalesChannelOrderReconciliation', inputVars);
}
requestSalesChannelOrderReconciliationRef.operationName = 'RequestSalesChannelOrderReconciliation';
exports.requestSalesChannelOrderReconciliationRef = requestSalesChannelOrderReconciliationRef;
...
const mapSalesChannelOrderItemRef = (dcOrVars, vars) => {
  const { dc: dcInstance, vars: inputVars} = validateArgs(connectorConfig, dcOrVars, vars, true);
  dcInstance._useGeneratedSdk();
  return mutationRef(dcInstance, 'MapSalesChannelOrderItem', inputVars);
}
mapSalesChannelOrderItemRef.operationName = 'MapSalesChannelOrderItem';
exports.mapSalesChannelOrderItemRef = mapSalesChannelOrderItemRef;

exports.mapSalesChannelOrderItem = function mapSalesChannelOrderItem(dcOrVars, vars) {
  const { dc: dcInstance, vars: inputVars } = validateArgs(connectorConfig, dcOrVars, vars, true);
  return executeMutation(mapSalesChannelOrderItemRef(dcInstance, inputVars));
}
;

const requestSalesChannelSyncRef = (dcOrVars, vars) => {
  const { dc: dcInstance, vars: inputVars} = validateArgs(connectorConfig, dcOrVars, vars, true);
  dcInstance._useGeneratedSdk();
...
exports.requestSalesChannelSyncRef = requestSalesChannelSyncRef;

exports.requestSalesChannelSync = function requestSalesChannelSync(dcOrVars, vars) {
  const { dc: dcInstance, vars: inputVars } = validateArgs(connectorConfig, dcOrVars, vars, true);
  return executeMutation(requestSalesChannelSyncRef(dcInstance, inputVars));
}
;

const requestSalesChannelAuthorizationRef = (dcOrVars, vars) => {
  const { dc: dcInstance, vars: inputVars} = validateArgs(connectorConfig, dcOrVars, vars, true);
  dcInstance._useGeneratedSdk();
  return mutationRef(dcInstance, 'RequestSalesChannelAuthorization', inputVars);
}
requestSalesChannelAuthorizationRef.operationName = 'RequestSalesChannelAuthorization';
exports.requestSalesChannelAuthorizationRef = requestSalesChannelAuthorizationRef;

exports.requestSalesChannelAuthorization = function requestSalesChannelAuthorization(dcOrVars, vars) {
  const { dc: dcInstance, vars: inputVars } = validateArgs(connectorConfig, dcOrVars, vars, true);
  return executeMutation(requestSalesChannelAuthorizationRef(dcInstance, inputVars));
}
;

const systemClaimSalesChannelWorkRef = (dcOrVars, vars) => {
  const { dc: dcInstance, vars: inputVars} = validateArgs(connectorConfig, dcOrVars, vars, true);
  dcInstance._useGeneratedSdk();
...
exports.systemClaimSalesChannelWorkRef = systemClaimSalesChannelWorkRef;

exports.systemClaimSalesChannelWork = function systemClaimSalesChannelWork(dcOrVars, vars) {
  const { dc: dcInstance, vars: inputVars } = validateArgs(connectorConfig, dcOrVars, vars, true);
  return executeMutation(systemClaimSalesChannelWorkRef(dcInstance, inputVars));
}
;

const systemUpdateSalesChannelConnectionRef = (dcOrVars, vars) => {
  const { dc: dcInstance, vars: inputVars} = validateArgs(connectorConfig, dcOrVars, vars, true);
  dcInstance._useGeneratedSdk();
...
exports.systemUpdateSalesChannelConnectionRef = systemUpdateSalesChannelConnectionRef;

exports.systemUpdateSalesChannelConnection = function systemUpdateSalesChannelConnection(dcOrVars, vars) {
  const { dc: dcInstance, vars: inputVars } = validateArgs(connectorConfig, dcOrVars, vars, true);
  return executeMutation(systemUpdateSalesChannelConnectionRef(dcInstance, inputVars));
}
;

const systemRegisterSalesChannelEventRef = (dcOrVars, vars) => {
  const { dc: dcInstance, vars: inputVars} = validateArgs(connectorConfig, dcOrVars, vars, true);
  dcInstance._useGeneratedSdk();
...
exports.systemRegisterSalesChannelEventRef = systemRegisterSalesChannelEventRef;

exports.systemRegisterSalesChannelEvent = function systemRegisterSalesChannelEvent(dcOrVars, vars) {
  const { dc: dcInstance, vars: inputVars } = validateArgs(connectorConfig, dcOrVars, vars, true);
  return executeMutation(systemRegisterSalesChannelEventRef(dcInstance, inputVars));
}
;

const systemRegisterSalesChannelEventsRef = (dcOrVars, vars) => {
  const { dc: dcInstance, vars: inputVars} = validateArgs(connectorConfig, dcOrVars, vars, true);
  dcInstance._useGeneratedSdk();
  return mutationRef(dcInstance, 'SystemRegisterSalesChannelEvents', inputVars);
}
systemRegisterSalesChannelEventsRef.operationName = 'SystemRegisterSalesChannelEvents';
exports.systemRegisterSalesChannelEventsRef = systemRegisterSalesChannelEventsRef;

exports.systemRegisterSalesChannelEvents = function systemRegisterSalesChannelEvents(dcOrVars, vars) {
  const { dc: dcInstance, vars: inputVars } = validateArgs(connectorConfig, dcOrVars, vars, true);
  return executeMutation(systemRegisterSalesChannelEventsRef(dcInstance, inputVars));
}
;

const systemMarkSalesChannelWebhookActiveRef = (dcOrVars, vars) => {
  const { dc: dcInstance, vars: inputVars} = validateArgs(connectorConfig, dcOrVars, vars, true);
  dcInstance._useGeneratedSdk();
  return mutationRef(dcInstance, 'SystemMarkSalesChannelWebhookActive', inputVars);
}
systemMarkSalesChannelWebhookActiveRef.operationName = 'SystemMarkSalesChannelWebhookActive';
exports.systemMarkSalesChannelWebhookActiveRef = systemMarkSalesChannelWebhookActiveRef;

exports.systemMarkSalesChannelWebhookActive = function systemMarkSalesChannelWebhookActive(dcOrVars, vars) {
  const { dc: dcInstance, vars: inputVars } = validateArgs(connectorConfig, dcOrVars, vars, true);
  return executeMutation(systemMarkSalesChannelWebhookActiveRef(dcInstance, inputVars));
}
;

const systemRecordSalesChannelEventResultRef = (dcOrVars, vars) => {
  const { dc: dcInstance, vars: inputVars} = validateArgs(connectorConfig, dcOrVars, vars, true);
  dcInstance._useGeneratedSdk();
...
exports.systemRecordSalesChannelEventResultRef = systemRecordSalesChannelEventResultRef;

exports.systemRecordSalesChannelEventResult = function systemRecordSalesChannelEventResult(dcOrVars, vars) {
  const { dc: dcInstance, vars: inputVars } = validateArgs(connectorConfig, dcOrVars, vars, true);
  return executeMutation(systemRecordSalesChannelEventResultRef(dcInstance, inputVars));
}
;

const systemIngestSalesChannelOrderRef = (dcOrVars, vars) => {
  const { dc: dcInstance, vars: inputVars} = validateArgs(connectorConfig, dcOrVars, vars, true);
  dcInstance._useGeneratedSdk();
...
exports.systemIngestSalesChannelOrderRef = systemIngestSalesChannelOrderRef;

exports.systemIngestSalesChannelOrder = function systemIngestSalesChannelOrder(dcOrVars, vars) {
  const { dc: dcInstance, vars: inputVars } = validateArgs(connectorConfig, dcOrVars, vars, true);
  return executeMutation(systemIngestSalesChannelOrderRef(dcInstance, inputVars));
}
;

const systemApplySalesChannelOrderEventRef = (dcOrVars, vars) => {
  const { dc: dcInstance, vars: inputVars} = validateArgs(connectorConfig, dcOrVars, vars, true);
  dcInstance._useGeneratedSdk();
  return mutationRef(dcInstance, 'SystemApplySalesChannelOrderEvent', inputVars);
}
systemApplySalesChannelOrderEventRef.operationName = 'SystemApplySalesChannelOrderEvent';
exports.systemApplySalesChannelOrderEventRef = systemApplySalesChannelOrderEventRef;

exports.systemApplySalesChannelOrderEvent = function systemApplySalesChannelOrderEvent(dcOrVars, vars) {
  const { dc: dcInstance, vars: inputVars } = validateArgs(connectorConfig, dcOrVars, vars, true);
  return executeMutation(systemApplySalesChannelOrderEventRef(dcInstance, inputVars));
}
;

const systemReconcileSalesChannelCommerceRef = (dcOrVars, vars) => {
  const { dc: dcInstance, vars: inputVars} = validateArgs(connectorConfig, dcOrVars, vars, true);
  dcInstance._useGeneratedSdk();
  return mutationRef(dcInstance, 'SystemReconcileSalesChannelCommerce', inputVars);
}
systemReconcileSalesChannelCommerceRef.operationName = 'SystemReconcileSalesChannelCommerce';
exports.systemReconcileSalesChannelCommerceRef = systemReconcileSalesChannelCommerceRef;

exports.systemReconcileSalesChannelCommerce = function systemReconcileSalesChannelCommerce(dcOrVars, vars) {
  const { dc: dcInstance, vars: inputVars } = validateArgs(connectorConfig, dcOrVars, vars, true);
...
const systemQueueDueSalesChannelSyncJobsRef = (dcOrVars, vars) => {
  const { dc: dcInstance, vars: inputVars} = validateArgs(connectorConfig, dcOrVars, vars, true);
  dcInstance._useGeneratedSdk();
  return mutationRef(dcInstance, 'SystemQueueDueSalesChannelSyncJobs', inputVars);
}
systemQueueDueSalesChannelSyncJobsRef.operationName = 'SystemQueueDueSalesChannelSyncJobs';
exports.systemQueueDueSalesChannelSyncJobsRef = systemQueueDueSalesChannelSyncJobsRef;

exports.systemQueueDueSalesChannelSyncJobs = function systemQueueDueSalesChannelSyncJobs(dcOrVars, vars) {
  const { dc: dcInstance, vars: inputVars } = validateArgs(connectorConfig, dcOrVars, vars, true);
  return executeMutation(systemQueueDueSalesChannelSyncJobsRef(dcInstance, inputVars));
}
;

const systemPurgeExpiredSalesChannelPayloadsRef = (dcOrVars, vars) => {
  const { dc: dcInstance, vars: inputVars} = validateArgs(connectorConfig, dcOrVars, vars, true);
  dcInstance._useGeneratedSdk();
  return mutationRef(dcInstance, 'SystemPurgeExpiredSalesChannelPayloads', inputVars);
}
systemPurgeExpiredSalesChannelPayloadsRef.operationName = 'SystemPurgeExpiredSalesChannelPayloads';
exports.systemPurgeExpiredSalesChannelPayloadsRef = systemPurgeExpiredSalesChannelPayloadsRef;

exports.systemPurgeExpiredSalesChannelPayloads = function systemPurgeExpiredSalesChannelPayloads(dcOrVars, vars) {
  const { dc: dcInstance, vars: inputVars } = validateArgs(connectorConfig, dcOrVars, vars, true);
  return executeMutation(systemPurgeExpiredSalesChannelPayloadsRef(dcInstance, inputVars));
}
;

const systemRecordSalesChannelCommandResultRef = (dcOrVars, vars) => {
  const { dc: dcInstance, vars: inputVars} = validateArgs(connectorConfig, dcOrVars, vars, true);
  dcInstance._useGeneratedSdk();
...
exports.systemRecordSalesChannelCommandResultRef = systemRecordSalesChannelCommandResultRef;

exports.systemRecordSalesChannelCommandResult = function systemRecordSalesChannelCommandResult(dcOrVars, vars) {
  const { dc: dcInstance, vars: inputVars } = validateArgs(connectorConfig, dcOrVars, vars, true);
...
exports.systemRecordSalesChannelSyncResultRef = systemRecordSalesChannelSyncResultRef;

exports.systemRecordSalesChannelSyncResult = function systemRecordSalesChannelSyncResult(dcOrVars, vars) {
  const { dc: dcInstance, vars: inputVars } = validateArgs(connectorConfig, dcOrVars, vars, true);
  return executeMutation(systemRecordSalesChannelSyncResultRef(dcInstance, inputVars));
}
;

const systemRecordSalesChannelMappingResultRef = (dcOrVars, vars) => {
  const { dc: dcInstance, vars: inputVars} = validateArgs(connectorConfig, dcOrVars, vars, true);
  dcInstance._useGeneratedSdk();
...
exports.systemRecordSalesChannelMappingResultRef = systemRecordSalesChannelMappingResultRef;

exports.systemRecordSalesChannelMappingResult = function systemRecordSalesChannelMappingResult(dcOrVars, vars) {
  const { dc: dcInstance, vars: inputVars } = validateArgs(connectorConfig, dcOrVars, vars, true);
...
const salesChannelOptionsRef = (dcOrVars, vars) => {
  const { dc: dcInstance, vars: inputVars} = validateArgs(connectorConfig, dcOrVars, vars, true);
  dcInstance._useGeneratedSdk();
...
const salesChannelConnectionsV2Ref = (dcOrVars, vars) => {
  const { dc: dcInstance, vars: inputVars} = validateArgs(connectorConfig, dcOrVars, vars, true);
  dcInstance._useGeneratedSdk();
...
const salesChannelProductMappingsV2Ref = (dcOrVars, vars) => {
  const { dc: dcInstance, vars: inputVars} = validateArgs(connectorConfig, dcOrVars, vars, true);
  dcInstance._useGeneratedSdk();
...
const salesChannelProductOptionsRef = (dcOrVars, vars) => {
  const { dc: dcInstance, vars: inputVars} = validateArgs(connectorConfig, dcOrVars, vars, true);
  dcInstance._useGeneratedSdk();
...
const salesChannelOperationsRef = (dcOrVars, vars) => {
  const { dc: dcInstance, vars: inputVars} = validateArgs(connectorConfig, dcOrVars, vars, true);
  dcInstance._useGeneratedSdk();
...
const systemSalesChannelWorkQueueRef = (dcOrVars, vars) => {
  const { dc: dcInstance, vars: inputVars} = validateArgs(connectorConfig, dcOrVars, vars, true);
  dcInstance._useGeneratedSdk();
...
const systemIfoodConnectionsForPollingRef = (dcOrVars, vars) => {
  const { dc: dcInstance, vars: inputVars} = validateArgs(connectorConfig, dcOrVars, vars, true);
  dcInstance._useGeneratedSdk();
  return queryRef(dcInstance, 'SystemIfoodConnectionsForPolling', inputVars);
}
...
const systemIfoodConnectionByMerchantRef = (dcOrVars, vars) => {
  const { dc: dcInstance, vars: inputVars} = validateArgs(connectorConfig, dcOrVars, vars, true);
  dcInstance._useGeneratedSdk();
  return queryRef(dcInstance, 'SystemIfoodConnectionByMerchant', inputVars);
}
...
const systemIfoodConnectionsByMerchantsRef = (dcOrVars, vars) => {
  const { dc: dcInstance, vars: inputVars} = validateArgs(connectorConfig, dcOrVars, vars, true);
  dcInstance._useGeneratedSdk();
  return queryRef(dcInstance, 'SystemIfoodConnectionsByMerchants', inputVars);
}
...
const systemSalesChannelMappingsForSyncRef = (dcOrVars, vars) => {
  const { dc: dcInstance, vars: inputVars} = validateArgs(connectorConfig, dcOrVars, vars, true);
  dcInstance._useGeneratedSdk();
  return queryRef(dcInstance, 'SystemSalesChannelMappingsForSync', inputVars);
}
...
const salesChannelOrdersV2Ref = (dcOrVars, vars) => {
  const { dc: dcInstance, vars: inputVars} = validateArgs(connectorConfig, dcOrVars, vars, true);
  dcInstance._useGeneratedSdk();
...
const salesChannelOrdersRef = (dcOrVars, vars) => {
  const { dc: dcInstance, vars: inputVars} = validateArgs(connectorConfig, dcOrVars, vars, true);
  dcInstance._useGeneratedSdk();
  return queryRef(dcInstance, 'SalesChannelOrders', inputVars);
}
...
const latestPendingSalesChannelOrderRef = (dcOrVars, vars) => {
  const { dc: dcInstance, vars: inputVars} = validateArgs(connectorConfig, dcOrVars, vars, true);
  dcInstance._useGeneratedSdk();
  return queryRef(dcInstance, 'LatestPendingSalesChannelOrder', inputVars);
}
...
const platformBillingWorkspaceV2Ref = (dcOrVars, vars) => {
  const { dc: dcInstance, vars: inputVars} = validateArgs(connectorConfig, dcOrVars, vars, true);
  dcInstance._useGeneratedSdk();
...
const systemSalesChannelConnectionForActorRef = (dcOrVars, vars) => {
  const { dc: dcInstance, vars: inputVars} = validateArgs(connectorConfig, dcOrVars, vars, true);
  dcInstance._useGeneratedSdk();
  return queryRef(dcInstance, 'SystemSalesChannelConnectionForActor', inputVars);
}
