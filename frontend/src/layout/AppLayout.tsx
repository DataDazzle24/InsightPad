...
export function AppLayout() {
  ...
  const isPlatformAdmin = profile?.role.systemRole === true && profile.role.name === 'Administrador da Plataforma'
    ...
    <main className="app-frame">
      ...
      <aside className={drawerOpen ? 'user-drawer user-drawer--open' : 'user-drawer'} aria-hidden={!drawerOpen}>
        ...
        <nav className="user-drawer__actions">
          {isPlatformAdmin && <Link to="/configuracoes/acessos" onClick={() => setDrawerOpen(false)}><span className="material-symbols-rounded">admin_panel_settings</span>Gestão de acessos e plataforma</Link>}
        </nav>
